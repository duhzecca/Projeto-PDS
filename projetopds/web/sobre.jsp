            ...
            <div id="main" class="shell">
                ...
                <div id="content">
                    ...
                    <div class="products">
                        ...
                        <p>Criado pela empresa <a href="http://pdsufscar.appspot.com/" target="_blank">CardBoardBox Software</a> durante 2º semestre de 2014.</p>
                        <p>Criada inicialmente para a disciplina de PDS e ES na UFSCar Sorocaba. Pelos alunos André Mitsuoka, Alyson Rodrigues, Eduardo Zecca e Lucas Arantes.</p>
                        </br>
                <p>Toda documentação desse projeto encontra-se em nosso <a href="http://pdsufscar.appspot.com/" target="_blank">site</a>, visite-nos!</p>
                        </br><p>Alguma sugestão ou reclamação? Mande um e-mail para: alyson.rodrigues.rosa@gmail.com </p>
                        </br><p>Deseja trabalhar conosco? (Apesar do grupo ser de 4 integrantes, aceitamos ajuda!) Sem recompensação financeira no momento :( </p>
                        <p>E-mail para <a>trabalheconosco.cardboard@gmail.com</a></p>
                    </div>
                    <div class="cl">&nbsp;</div>
                </div>
                <!-- End Content -->
