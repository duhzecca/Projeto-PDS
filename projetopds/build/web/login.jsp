...
<html>
  ...
  <body>
    ...
    %>
    <div id="login">
      <h1 style="text-align: center"><a href="index.jsp" title="Login">Drogaria.Me</a></h1><br><br><br>
      <label style="margin-left: 25%; font-size: 24px; color: #01B508;">Acesso de Usuário</label>
      <form id="loginForm" method="post" onsubmit="return VerificaEmail(document.getElementById('usuarioLogin').value)" action="ValidaLogin">
        ...
        <a href="esqueceuSenha.jsp" style="font-size: 12px;">Esqueci minha senha</a><br><br>
        <input type="checkbox"/>
